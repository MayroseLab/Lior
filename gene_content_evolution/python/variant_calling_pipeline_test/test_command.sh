...
snakemake -s ../variant_calling_pipeline.snakefile --configfile test.conf.yml --cluster "python ../pbs_qsub_snakemake_wrapper.py" --latency-wait 60 --use-conda -p -j 10 --jobscript "/groups/itay_mayrose/nosnap/liorglic/Projects/tomato_pan_genome/python/jobscript.sh"
