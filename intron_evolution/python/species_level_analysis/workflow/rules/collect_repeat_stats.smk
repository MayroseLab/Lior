rule collect_repeat_stats:
    ...
    run:
        ...
        headers = ['Repeat type', 'Assembly size', 'Total repeas', 'Total introns', 'Total intergenic', 'Percent of genome covered by repeats', 'Percent of introns covered by repeats', 'Percent of intergenic covered by repeats']
